...
# Writeup
Trying to figure out how to make a car find its way around a track is difficult. Trying to find a good logic model that generalized to most situiations takes a lot of plotting out, and making a car drive smoothly is a problem in itself. HEre's how I did it.
...
- Changing lanes smoothly. This is done with a Jerk-Minimizing Trajectory, which is a simple matrix multiplication. We take the position we're at and find the trajectory that gets us from the lane we're in to the lane we want to be in the smoothest.

### Simulator. You can download the Term3 Simulator BETA which contains the Path Planning Project from the [releases tab](https://github.com/udacity/self-driving-car-sim/releases).

#### Note. This project is tested only on simulator v1.2
